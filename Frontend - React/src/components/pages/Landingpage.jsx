...
const Button = ({ children, className, variant }) => (
  <button
    className={`px-6 py-3 rounded-full text-lg font-semibold transition-transform duration-300 transform ${
      variant === 'outline' ? 'border border-blue-500 text-white-500 hover:bg-blue-500 hover:text-white' : 'bg-blue-600 hover:bg-blue-700 text-white'
    } ${className}`}
  >
    {children}
  </button>
...
const FeatureCard = ({ icon: Icon, title, description }) => (
  <div className="flex flex-col items-center text-center p-6 bg-gray-800 rounded-lg transition-transform duration-300 transform hover:scale-105 hover:shadow-lg">
    <Icon className="w-12 h-12 mb-4 text-blue-500 transition-colors duration-300 hover:text-blue-400" />
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <header className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-xl text-gray-400">Audio Censorship for a Cleaner Digital World</p>
      </header>

      {/* How It Works */}
      <section className="container mx-auto px-4 py-16">
        <h2 className="mb-8 text-3xl font-bold text-center text-white">How It Works</h2>
        <p className="mb-8 text-center text-gray-400 max-w-2xl mx-auto">
          Our powerful AI model processes your audio files to detect and censor any curse words, ensuring a safe, family-friendly environment for all listeners.
        </p>
      ...
      {/* Features */}
      <section className="container mx-auto px-4 py-16 bg-gradient-to-r from-blue-900 to-purple-900">
        <h2 className="mb-8 text-3xl font-bold text-center text-white">Features</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <FeatureCard
            icon={LuZap}
      ...
      <section className="container mx-auto px-4 py-16">
        <h2 className="mb-8 text-3xl font-bold text-center text-white">Why Choose SafeSound AI?</h2>
        <div className="grid md:grid-cols-2 gap-8">
          {[ 
            { icon: LuShield, title: "Protect Your Audience", description: "Maintain a positive environment, free from harmful or offensive language." },
            { icon: LuGlobe, title: "Enhance Content Accessibility", description: "Make your audio content suitable for all audiences, including younger listeners." },
            { icon: LuZap, title: "AI-Powered Precision", description: "Advanced NLP and audio processing techniques ensure high accuracy and minimal false positives." },
            { icon: LuLock, title: "Privacy-Focused", description: "We prioritize user data protection. Your audio files are processed securely and are never stored without your permission." },
          ].map((item, index) => (
            <div key={index} className="flex items-start p-6 bg-gray-800 rounded-lg transition-transform duration-300 hover:scale-105 hover:shadow-lg">
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="mb-8 text-gray-400 max-w-2xl mx-auto">
          Upload an audio file to see our AI in action and experience the power of real-time curse word censorship.
        </p>
      ...
      <footer className="bg-gray-800 py-8 text-center">
        <p className="text-gray-400">&copy; 2023 SafeSound AI. All rights reserved.</p>
        <div className="mt-4">
